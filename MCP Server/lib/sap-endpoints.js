...
const ENDPOINTS = [
  ...
  { key: 'purchase_requisition_v4', category: '采购', name: '采购申请 V4', scenario: 'SAP_COM_0102', method: 'GET', protocol: 'OData V4/JSON', pathTemplate: '/sap/opu/odata4/sap/api_purchaserequisition/srvd_a2x/sap/purchaserequisition/0001/PurchaseRequisition?$top=1&$format=json&sap-client={CLIENT}', note: '需开通SAP_COM_0102', 分类: '采购', 名称: '采购申请 V4', 场景: 'SAP_COM_0102', 方法: 'GET', 协议: 'OData V4/JSON', 备注: '需开通SAP_COM_0102' },
  { key: 'purchase_requisition_item_v4', category: '采购', name: '采购申请行 V4', scenario: 'SAP_COM_0102', method: 'GET', protocol: 'OData V4/JSON', pathTemplate: '/sap/opu/odata4/sap/api_purchaserequisition/srvd_a2x/sap/purchaserequisition/0001/PurchaseRequisitionItem?$top=1&$format=json&sap-client={CLIENT}', note: '需开通SAP_COM_0102', 分类: '采购', 名称: '采购申请行 V4', 场景: 'SAP_COM_0102', 方法: 'GET', 协议: 'OData V4/JSON', 备注: '需开通SAP_COM_0102' },
